...
class StreamlitUI:
    ...
    def init_session_state(self):
        ...
        if 'notion_run_url' not in st.session_state:
            st.session_state.notion_run_url = ""
        ...
        try:
            ...
            if results:
                ...
                if self.notion_publisher.is_enabled():
                    ...
                    # If a Notion URL was produced, surface it immediately
                    if st.session_state.notion_run_url:
                        st.success(f"📊 View results in Notion: [Open]({st.session_state.notion_run_url})")
